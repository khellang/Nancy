namespace Nancy.ViewEngines
{
    ...
    {
        private readonly ConcurrentDictionary<ViewLocationResult, Task<object>> cache;
        ...
        {
            this.cache = new ConcurrentDictionary<ViewLocationResult, Task<object>>();
        ...
        public async Task<TCompiledView> GetOrAdd<TCompiledView>(ViewLocationResult viewLocationResult, Func<ViewLocationResult, Task<TCompiledView>> valueFactory)
        {
            ...
            return (TCompiledView) await this.cache.GetOrAdd(viewLocationResult, async x => await valueFactory(x));
        }
    }
}
